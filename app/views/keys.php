    ...
    <main class="poc-content">
        ...
        <div class="poc-grid">
            <div class="poc-step-box">
                ...
                <p>Log in to the <strong>Pocket Merchant Portal.</strong></p>
                <img src="../public/images/keys/pmp.png" alt="Pocket Merchant Portal" class="poc-image-small" onclick="openModal(this.src)">
            </div>
            <div class="poc-step-box">
                <div class="step-number">2</div>
                <p>Navigate to the <strong>Terminal</strong> page.</p>
                <img src="../public/images/keys/tp.png" alt="Terminal Page" class="poc-image-small" onclick="openModal(this.src)">
            </div>
            <div class="poc-step-box">
                <div class="step-number">3</div>
                <p>Create a new Terminal Slot. Each slot indicates a different payment terminal, which will be reflected in the payment receipt of your client. <strong>Make sure each terminal ID is unique.</strong></p>
                <img src="../public/images/keys/ts.png" alt="Terminal Slot" class="poc-image-small" onclick="openModal(this.src)">
            </div>
            <div class="poc-step-box">
                <div class="step-number">4</div>
                <p>Make sure to assign your phone number to the newly created terminal.</p>
                <img src="../public/images/keys/apn.png" alt="Assign Phone Number" class="poc-image-small" onclick="openModal(this.src)">
            </div>
            <div class="poc-step-box">
                <div class="step-number">5</div>
                <p>Then, navigate to the <strong>Manage Keys</strong> page. Your API salt & API key will be shown here once created.</p>
                <img src="../public/images/keys/mkp.png" alt="Manage Keys Page" class="poc-image-small" onclick="openModal(this.src)">
            </div>
            <div class="poc-step-box">
                <div class="step-number">6</div>
                <p>Click on <strong>Generate New Keys.</strong></p>
                <img src="../public/images/keys/gnk.png" alt="Generate New Keys" class="poc-image-small" onclick="openModal(this.src)">
            </div>
            <div class="poc-step-box">
            ...
            <div class="poc-step-box">
                ...
                <img src="../public/images/keys/kgs.png" alt="Keys Generated Successfully" class="poc-image-small" onclick="openModal(this.src)">
            </div>
        </div>
