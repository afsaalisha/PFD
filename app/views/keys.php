    ...
    <main class="key-content">
        ...
        <ol>
            <li>
                ...
                <img src="../public/images/keys/pmp.png" alt="Pocket Merchant Portal" class="key-image">
            </li>
            <li>
                <p>Navigate to the <strong>Terminal</strong> page.</p>
                <img src="../public/images/keys/tp.png" alt="Terminal Page" class="key-image">
            </li>
            <li>
                ...
                <img src="../public/images/keys/ts.png" alt="Terminal Slot" class="key-image">
            </li>
            <li>
                <p>Make sure to assign your phone number to the newly created terminal.</p>
                <img src="../public/images/keys/apn.png" alt="Assign Phone Number" class="key-image">
            </li>
            <li>
                <p>Then, navigate to the <strong>Manage Keys</strong> page. Your API salt & API key will be shown here once created.</p>
                <img src="../public/images/keys/mkp.png" alt="Manage Keys Page" class="key-image">
            </li>
            <li>
                <p>Click on <strong>Generate New Keys.</strong></p>
                <img src="../public/images/keys/gnk.png" alt="Generate New Keys" class="key-image">
            </li>
            <li>
                <p>Select the terminal you created and then click on <strong>Generate.</strong></p>
                <img src="../public/images/keys/stag.png" alt="Select Terminal and Generate" class="key-image">
            </li>
            <li>
                ...
                <img src="../public/images/keys/kgs.png" alt="Keys Generated Successfully" class="key-image">
            </li>
        </ol>
